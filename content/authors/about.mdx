...
<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4  gap-4">
  <div className="text-center">
    ...
    <a href="Coming soon" target="_blank">
      <img src="https://images.credly.com/size/680x680/images/526ad7ad-52f2-4922-9fa8-879fea71e286/image.png" alt="AWS Knowledge: Storage Technologist" className="mx-auto" />
    </a>

    <strong>Issued On:</strong> Coming soon
  ...
  <div className="text-center">
    ...
    <a href="https://www.credly.com/badges/df07128a-b1d8-4e2b-be42-7a9463f4aafe" target="_blank">
      <img src="https://images.credly.com/size/680x680/images/9bcbde6d-1754-4617-9337-124f7b10a6c2/image.png" alt="AWS Knowledge: Amazon EKS" className="mx-auto" />
    </a>
  ...
  <div className="text-center">
    ...
    <a href="https://www.credly.com/badges/6fed4a9a-21f2-4acf-9385-7223a3168a86" target="_blank">
      <img src="https://images.credly.com/size/680x680/images/519a6dba-f145-4c1a-85a2-1d173d6898d9/image.png" alt="AWS Solution Architecture" className="mx-auto" />
    </a>
  ...
  <div className="text-center">
    ...
    <a href="https://www.credly.com/badges/6fed4a9a-21f2-4acf-9385-7223a3168a86" target="_blank">
      <img src="https://images.credly.com/size/680x680/images/ec621e2a-c8f0-4459-806c-ae11829d372a/image.png" alt="AWS Knowledge: Cloud Essentials" className="mx-auto" />
    </a>
