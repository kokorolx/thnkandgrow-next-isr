---
title: 'Những công nghệ mà pinterest đã/đang dùng(2013)'
date: '2021-09-26'
categories:
  - 'architecture'
  - 'technology'
tags:
  ...
  - 'redis'
  - 'solr'
coverImage: 'pinterest-technology.x40801.png'
...
![](/static/blog/images/aws-logo.png)
...
![](/static/blog/images/mysql-1-1600340047538868003500-crop-160034079526453914971.png)
...
![](/static/blog/images/download.jpeg)
...
![](/static/blog/images/Redis_Logo.svg_-1.png)
...
![](/static/blog/images/download.png)
...
![Clustering Vs Sharding](/static/blog/images/The-sharding-technology-partitions-the-network-into-different-groups-while-each-of-the.png)
...
- Cons (from first hand experience):
  - Still fairly young.**(the origin blog wrote from 2013, now is 2021)**
...
- Pros:
  ...
  - High availability
  - Load balancing
  - Algorithm for placing data is very simple. The main reason. Has a [SPOF](https://en.wikipedia.org/wiki/Single_point_of_failure), but it’s half a page of code rather than a very complicated Cluster Manager. After the first day it will work or won’t work.
...
- Looked at [Cassandra’s ring model](https://cassandra.apache.org/_/index.html). Looked at [Membase](https://www.couchbase.com/press-releases/membase-general-availability). And looked at [Twitter’s Gizzard](https://blog.twitter.com/engineering/en_us/a/2010/introducing-gizzard-a-framework-for-creating-distributed-datastores).
...
- Hacked up a copy of [Pyres](https://github.com/binarymatt/pyres), a Python interface to Github’s Resque queue, a queue on built on top of redis. Supports priorities and retries. It was so good they replaced Celery and RabbitMQ with Pyres.
...
> [from: http://highscalability.com/blog/2013/4/15/scaling-pinterest-from-0-to-10s-of-billions-of-page-views-a.html](http://highscalability.com/blog/2013/4/15/scaling-pinterest-from-0-to-10s-of-billions-of-page-views-a.html)
